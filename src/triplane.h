...
extern std::unique_ptr<gfx::bitmap::Bitmap> board;
extern std::unique_ptr<gfx::bitmap::Bitmap> board2;
extern std::unique_ptr<gfx::bitmap::Bitmap> pwon;
extern std::unique_ptr<gfx::bitmap::Bitmap> pwoff;
extern std::unique_ptr<gfx::bitmap::Bitmap> picons[4];
extern std::unique_ptr<gfx::bitmap::Bitmap> plane1;
extern std::unique_ptr<gfx::bitmap::Bitmap> planes[16][61][4][2];
extern std::unique_ptr<gfx::bitmap::Bitmap> bomb[61];
extern std::unique_ptr<gfx::bitmap::Bitmap> boards[4];
extern std::unique_ptr<gfx::bitmap::Bitmap> closed;
extern std::unique_ptr<gfx::bitmap::Bitmap> bomb_icon;
extern std::unique_ptr<gfx::bitmap::Bitmap> gas_icon;
extern std::unique_ptr<gfx::bitmap::Bitmap> small_ammo_icon;
extern std::unique_ptr<gfx::bitmap::Bitmap> big_ammo_icon;
extern std::unique_ptr<gfx::bitmap::Bitmap> plane_crash[6];
extern std::unique_ptr<gfx::bitmap::Bitmap> smoke[SMOKE_FRAMES];
extern std::unique_ptr<gfx::bitmap::Bitmap> wave1[WAVE1_FRAMES];
extern std::unique_ptr<gfx::bitmap::Bitmap> wave2[WAVE2_FRAMES];
extern std::unique_ptr<gfx::bitmap::Bitmap> explox[4][EXPLOX_FRAMES];
extern std::unique_ptr<gfx::bitmap::Bitmap> maisema;
extern std::unique_ptr<gfx::bitmap::Bitmap> bites[NUMBER_OF_BITES];
extern std::unique_ptr<gfx::bitmap::Bitmap> menu1;
extern std::unique_ptr<gfx::bitmap::Bitmap> structures[MAX_STRUCTURES][2];
extern std::unique_ptr<gfx::bitmap::Bitmap> temp_bitti;
extern std::unique_ptr<gfx::bitmap::Bitmap> cursor;
extern std::unique_ptr<gfx::bitmap::Bitmap> kkbase[2][3][7];
extern std::unique_ptr<gfx::bitmap::Bitmap> infantry_walking[4][2][12];
extern std::unique_ptr<gfx::bitmap::Bitmap> infantry_dying[4][2][7];
extern std::unique_ptr<gfx::bitmap::Bitmap> infantry_aiming[4][2][6];
extern std::unique_ptr<gfx::bitmap::Bitmap> infantry_wavedeath[4][2][10];
extern std::unique_ptr<gfx::bitmap::Bitmap> infantry_shooting[4][2][6];
extern std::unique_ptr<gfx::bitmap::Bitmap> infantry_bdying[4][2][10];
extern std::unique_ptr<gfx::bitmap::Bitmap> infantry_dropping[4][2];
extern std::unique_ptr<gfx::bitmap::Bitmap> infantry_after_drop[4][2];
extern std::unique_ptr<gfx::bitmap::Bitmap> itexplosion[ITEXPLOSION_FRAMES];
extern std::unique_ptr<gfx::bitmap::Bitmap> flames[6];
extern std::unique_ptr<gfx::bitmap::Bitmap> status_icons[2][2];
extern std::unique_ptr<gfx::bitmap::Bitmap> hangarmenu;
extern std::unique_ptr<gfx::bitmap::Bitmap> hangaractive;
extern std::unique_ptr<gfx::bitmap::Bitmap> hangarinactive;
extern std::unique_ptr<gfx::bitmap::Bitmap> radar[4][8];
extern std::unique_ptr<gfx::bitmap::Bitmap> rifle[12];
extern std::unique_ptr<gfx::bitmap::Bitmap> hruks;
extern std::unique_ptr<gfx::bitmap::Bitmap> ssmoke[17];
extern std::unique_ptr<gfx::bitmap::Bitmap> ovi[13];
extern std::unique_ptr<gfx::bitmap::Bitmap> mekan_running[14][2];
extern std::unique_ptr<gfx::bitmap::Bitmap> mekan_pushing[2][14][2];
...
extern std::unique_ptr<gfx::bitmap::Bitmap> flags[4][12];
